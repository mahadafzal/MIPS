...
public:
  ...
  // Stores the decoded MIPS assembly instruction passed in
  void setAssembly(string s) { myDecoding = s;};
  
  // Returns string representing the decoded MIPS assembly instruction
  string getAssembly() { return myDecoding; };
